...
apt update
apt upgrade -y
apt install curl build-essential dbus-x11 git cmake clang-format python3 python3-pip python-is-python3 libusb-1.0-0-dev libncurses-dev libncursesw6 srecord -y
